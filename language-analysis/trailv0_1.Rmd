...
- What is messing up generation of ngrams?!
...
swear words from [here](https://github.com/RobertJGabriel/Google-profanity-words)
...
n          <- 1001
profanity  <- readFile("./data/Google-profanity-words/list.txt")
us.blogs   <-
...
forceClean  <- function(input) {
    input[-(stri_detect(c(tmpVar$term), fixed = "\"") %>% which),]
}
